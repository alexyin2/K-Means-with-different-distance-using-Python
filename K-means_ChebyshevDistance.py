...
# 3. Define Distance: Chebyshev Distance
def dist(a, b, ax=1):
    return np.linalg.norm(a - b, ord=np.inf, axis=ax)  # The meaning of axis=1 can be find on P.S


# 4. Clustering Preparation
# Since we're using Chebyshev Distance, perhaps normalizing the data may help with clustering.
